...
You do not need any special software to run this project. A standard web browser (Chrome, Safari, Firefox) and a code editor (VS Code, Sublime Text) are sufficient.

### Installation

1. **Clone the repository:**
   ```bash
   git clone [https://github.com/your-username/homebrew-padel-club.git](https://github.com/your-username/homebrew-padel-club.git)
